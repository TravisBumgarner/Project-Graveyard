...
interface UpdateCurrentlyTracked {
  type: 'UPDATE_CURRENTLY_TRACKED'
  payload: {
    projectId: string
    startTime: string
  } | null
...
const reducer = (state: State, action: Action): State => {
  switch (action.type) {
    ...
    case 'UPDATE_CURRENTLY_TRACKED': {
      return { ...state, currentlyTracked: action.payload }
    }
    default:
