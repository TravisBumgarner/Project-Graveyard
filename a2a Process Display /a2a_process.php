function a2a_process($user_class_toggles){
	...
	echo '<div class = "process_wrapper">';
	echo '<div class ="' . ($merged_class_toggles['process_plan']? "process_plan" : "process_not_active") . '"><p>Plan</p></div>';
	echo '<div class ="' . ($merged_class_toggles['process_learn'] ? "process_learn" : "process_not_active") . '"><p>Learn</p></div>';
	echo '<div class ="' . ($merged_class_toggles['process_analyze'] ? "process_analyze" : "process_not_active") . '"><p>Analyze</p></div>';
	echo '<div class ="' . ($merged_class_toggles['process_share'] ? "process_share" : "process_not_active") . '"><p>Share</p></div>';
	echo '<div class ="' . ($merged_class_toggles['process_act'] ? "process_act" : "process_not_active") . '"><p>Act</p></div>';
	echo'</div><!-- /process_wrapper -->';
}
