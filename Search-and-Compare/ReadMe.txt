...
filesearch.py - Is a script that takes the resulting list of and searches other directories for all files. It returns a list of all files found and their location and all files not found. 
